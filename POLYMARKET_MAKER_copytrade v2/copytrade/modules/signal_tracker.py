...
def topic_to_payload(topic: Topic, *, side: Optional[str] = None) -> Dict[str, object]:
...
def topics_to_payloads(
    topics: Iterable[Topic],
    *,
    side: Optional[str] = None,
) -> List[Dict[str, object]]:
    return [topic_to_payload(topic, side=side) for topic in topics]
